...
pub enum BodyPart {
    ...
    LeftArm, LeftArmLayer,
    RightLeg, RightLegLayer,
    LeftLeg, LeftLegLayer,
}
...
impl BodyPart {
    ...
    pub const LAYER_PARTS: [BodyPart; 6] = [
        BodyPart::HeadLayer, BodyPart::BodyLayer,
        BodyPart::RightArmLayer, BodyPart::LeftArmLayer,
        BodyPart::RightLegLayer, BodyPart::LeftLegLayer,
    ];
    ...
    pub fn size(&self, slim: bool) -> Vec3 {
        ...
        match self {
            ...
            BodyPart::RightArm | BodyPart::RightArmLayer
            | BodyPart::LeftArm | BodyPart::LeftArmLayer => Vec3::new(arm_w, 12.0, 4.0),
            BodyPart::RightLeg | BodyPart::RightLegLayer
            | BodyPart::LeftLeg | BodyPart::LeftLegLayer => Vec3::new(4.0, 12.0, 4.0),
        }
    }
    ...
    pub fn uvs(&self, slim: bool) -> CubeFaceUvs {
        ...
        match self {
            ...
            BodyPart::LeftArm | BodyPart::LeftArmLayer => {
                let base = if matches!(self, BodyPart::LeftArm) { 32 } else { 48 };
            ...
            BodyPart::LeftLeg | BodyPart::LeftLegLayer => {
                let base = if matches!(self, BodyPart::LeftLeg) { 16 } else { 0 };
